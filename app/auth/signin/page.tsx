        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <span className="font-semibold tracking-widest uppercase text-sm" style={{color: "#b9962f"}}>Welcome Back</span>
              <Crown className="w-8 h-8" style={{color: "#d4af37"}} />
            </div>
            <h1 className="text-4xl font-display font-bold golden-text-gradient mb-4">SIGN IN</h1>
            <p className="text-charcoal-700">Access your account to continue your premium shopping experience</p>
          </div>
          ...
          <div className="golden-card p-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    className="border-elegant-300"
                  />
                  <label htmlFor="remember" className="text-sm text-charcoal-700 cursor-pointer">
                    Remember me
                  </label>
                </div>
            ...
            <div className="my-8">
              ...
              <div className="relative -top-3 text-center">
                <span className="bg-white px-4 text-sm text-charcoal-600">OR CONTINUE WITH</span>
              </div>
            </div>
          ...
          {/* Benefits */}
          <div className="mt-8 golden-card p-6">
            <h3 className="text-lg font-display font-bold text-elegant-900 mb-4 text-center">MEMBER BENEFITS</h3>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <Shield className="w-5 h-5 text-gold-600" />
                <span className="text-charcoal-800">Secure & encrypted transactions</span>
              </div>
              <div className="flex items-center space-x-3">
                <Star className="w-5 h-5 text-gold-500" />
                <span className="text-charcoal-800">Exclusive member discounts</span>
              </div>
              <div className="flex items-center space-x-3">
                <Crown className="w-5 h-5" style={{color: "#d4af37"}} />
                <span className="text-charcoal-800">Priority customer support</span>
              </div>
            </div>
          </div>
        </div>
